        ...
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/1.1.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/2.1.ppt")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/3.2.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/2.4.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/3.4.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/4.1.ppt")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/4.2.1.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/3.5.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/5.1.ppt")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/5.2.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/5.3.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/6,3.ppt")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/6,2.ppt")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
            <li class="docs__item doc">
                ...
                <p class="doc__type">Презентация</p>
                <div class="doc__buttons">
                    <a href="<?php echo e(asset("public/6.4.pptx")); ?>" class="doc__button button">Открыть</a>
                </div>
            </li>
        </ul>
        <ul class="docs__list">
...
<?php echo $__env->make("layouts.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\help\resources\views/documents/materials.blade.php ENDPATH**/ ?>