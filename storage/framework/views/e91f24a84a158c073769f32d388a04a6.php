<?php $__env->startSection("content"); ?>
    ...
    <form action="<?php echo e(route("admin-create")); ?>" method="post" class="form" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <label for="name" class="form__label">
            Название документа:
            <input type="text" class="form__input" name="name" id="name" placeholder="document123..." value="<?php echo e(old("name")); ?>">
        </label>
...
<?php echo $__env->make("layouts.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\help\resources\views/admin/create.blade.php ENDPATH**/ ?>