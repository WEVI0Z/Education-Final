...
class DocumentsController extends Controller
{
    ...
    function createDoc(Request $request) {
        if ($_POST) {
            $rules = [
                ...
                "file" => "required|mimes:docx,pdf,html,pptx,ppt",
            ];
            ...
            $messages = [
                ...
                "file.mimes" => "Файл должен быть формата docx, pdf, ppt,pptx или html",
            ];
    ...
    function delete(Request $request) {
        ...
        foreach($document->statistics as $stat) {
            Statistic::query()->find($stat->id)->delete();
        }
    ...
    function materials() {
        ...
        return view("documents.materials", compact("title"));
    }
